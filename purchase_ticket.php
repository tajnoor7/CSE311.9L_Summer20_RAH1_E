...
$sql = "INSERT INTO booking (passenger_fname, passenger_lname, passenger_email, travel_from, travel_to, date, seat, class) VALUES 
('$passenger_fname', '$passenger_lname', '$passenger_email', '$travel_from' ,'$travel_to', '$date', '$seat', '$class')";
